    ...
    hover:shadow-md cursor-pointer h-[170px]'>
            ...
            <div className='mt-5'>
                <div className='flex items-center justify-between mb-3'>
                    <h2 className='text-xs test-slate-400'>${budget.totalSpend?budget.totalSpend:0} spent</h2>
                    <h2 className='text-xs test-slate-400'>${budget.amount-budget.totalSpend} remaining</h2>
                </div>
